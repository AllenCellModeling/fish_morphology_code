...
def distribute_autocontrasted_dataset(
    test=False,
    csv_loc="/allen/aics/gene-editing/FISH/2019/chaos/data/normalized_2D_tiffs/5500000322_500000323/image_manifest_final.csv",
    col_name_map={},
    dataset_name="2d_autocontrasted_fields_and_single_cells_actn2_2",
    ...
    ds = Dataset(
        ...
        readme_path="/allen/aics/gene-editing/FISH/2019/chaos/data/normalized_2D_tiffs/5500000322_500000323/README.md",
    )
