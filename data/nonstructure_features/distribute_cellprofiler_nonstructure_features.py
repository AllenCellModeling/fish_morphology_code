...
def make_test_csv(csv_loc="features2quilt.csv", out_loc="./"):
...
def distribute_cellprofiler_nonstructure_features(
    test=False,
    csv_loc="features2quilt.csv",
    dataset_name="2d_nonstructure_single_cell_features",
...
if __name__ == "__main__":
    fire.Fire(distribute_cellprofiler_nonstructure_features)
