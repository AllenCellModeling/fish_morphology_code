...
def make_test_csv(
    csv_loc="/allen/aics/gene-editing/FISH/2019/chaos/data/cp_20200921/merged_features/features2quilt/features2quilt.csv",
    out_loc="./",
):
...
def distribute_cellprofiler_features(
    test=False,
    csv_loc="/allen/aics/gene-editing/FISH/2019/chaos/data/cp_20200921/merged_features/features2quilt/features2quilt.csv",
    dataset_name="2d_autocontrasted_single_cell_features_actn2",
