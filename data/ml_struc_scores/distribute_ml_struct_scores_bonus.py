...
def distribute_struct_scores_bonus(
    test=False,
    csv_loc="/allen/aics/gene-editing/FISH/2019/chaos/data/20200911_classifier_features/manifest_20200911_tg.csv",
    ...
    ds = Dataset(
        ...
        readme_path="/allen/aics/gene-editing/FISH/2019/chaos/data/20200911_classifier_features/README.md",
    )
