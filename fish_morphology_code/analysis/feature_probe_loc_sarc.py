...
seg_folder = (
    "/allen/aics/modeling/data/cardio_fish/normalized_2D_tiffs/output_field_images"
)
class_folder = (
    "/allen/aics/assay-dev/MicroscopyOtherData/Viana/projects/assay-dev-cardio/output"
)
...
for index, row in sarc_names.iterrows():
    ...
    class_img_path = os.path.join(
        class_folder, row["ImagePath"].split("/")[-1].split("radon")[0] + "bkgrd.tif"
    )
