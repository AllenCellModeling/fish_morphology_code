...
for FOVId in tqdm(df_fov.index):
    ...
    prefix = os.path.join(source, f'fov_{FOVId}')
    ...
    if os.path.exists(prefix+'.csv'):
        ...
        df_fov['original_fov_location'] = df_fov.RawFileName[FOVId].replace('_C0.tif','')
